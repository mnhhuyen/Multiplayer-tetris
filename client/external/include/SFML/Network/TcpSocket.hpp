...
/// // ----- The client -----
///
/// // Create a socket and connect it to 192.168.1.50 on port 55002
/// sf::TcpSocket socket;
/// socket.connect("192.168.1.50", 55002);
///
...
/// // ----- The server -----
///
/// // Create a listener to wait for incoming connections on port 55002
